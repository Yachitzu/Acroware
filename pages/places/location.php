                ...
                <div class="col-md-12">
                    <div class="profile">
                        <div class="cover-image-gest d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5">
                            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase titleMain font-berthold">Ubicaciones</h1>
                            ...
                            <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>3</td>
                                        <td>PC-01</td>
                                        <td>Primer espacio de trabajo.</td>
                                        <td>Aula 01</td>
                                        <td>
                                            <center>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>PC-02</td>
                                        <td>Segundo espacio de trabajo.</td>
                                        <td>Aula 01</td>
                                        <td>
                                            <center>
                                                <button class="btn btn-warning btn-circle element-white editar" id="editar">
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>PC-03</td>
                                        <td>Tercer espacio de trabajo.</td>
                                        <td>Aula 01</td>
                                        <td>
                                            <center>
                                                <button class="btn btn-warning btn-circle element-white editar" id="editar">
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>PC-04</td>
                                        <td>Cuarto espacio de trabajo.</td>
                                        <td>Aula 01</td>
                                        <td>
                                            <center>
                                                <button class="btn btn-warning btn-circle element-white editar" id="editar">
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>PC-05</td>
                                        <td>Quinto espacio de trabajo.</td>
                                        <td>Aula 01</td>
                                        <td>
                                            <center>
                                                <button class="btn btn-warning btn-circle element-white editar" id="editar">
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>PC-06</td>
                                        <td>Sexto espacio de trabajo.</td>
                                        <td>Aula 01</td>
                                        <td>
                                            <center>
                                                <button class="btn btn-warning btn-circle element-white editar" id="editar">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="grid-margin-modal">          
                    <div class="card-body">
                        <p class="card-description">Por favor, complete los siguientes campos para agregar una nueva Ubicación de un Área al sistema:</p>
                        <div class="form-row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="grid-margin-modal">          
                    <div class="card-body">
                        <p class="card-description">Por favor, complete los siguientes campos para editar la información de la Ubicación seleccionada:</p>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="Name" class="text-bold">Nombre</label>
                                <input type="text" class="form-control" id="Name" placeholder="Nombre" oninput="this.value = this.value.replace(/[^A-Za-zÁÉÍÓÚáéíóúÑñ\s]/g, '');" required>
