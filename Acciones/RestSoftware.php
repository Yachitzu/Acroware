...
switch ($op) {
    ...
    case 'POST':
        ...
        $resultado = AccionesSoftware::insertarSoftware($nombre_software, $activado, $tipo_licencia, $fecha_adqui, $fecha_activacion);
    ...
    case "PUT":
        ...
        $resultado = AccionesSoftware::actualizarSoftware($id, $nombre_software, $activado, $tipo_licencia, $fecha_adqui, $fecha_activacion);
